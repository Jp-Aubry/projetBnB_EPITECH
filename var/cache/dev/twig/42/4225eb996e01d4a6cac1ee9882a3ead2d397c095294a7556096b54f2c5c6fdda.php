...
class __TwigTemplate_e4cb378bce40bfa9ba62bcbf9dafa8eb70556d3542cfa049f099e6d76311d30b extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container\">
        <div class=\"row align-items-center mb-5\">
            <div class=\"col-md-3 text-center\">
                <img src=\"";
        // line 10
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 10, $this->source); })()), "picture", [], "any", false, false, false, 10), "html", null, true);
        ...
        <h2>Les annonces de ";
        // line 29
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 29, $this->source); })()), "fullName", [], "any", false, false, false, 29), "html", null, true);
        echo "</h2>

        ";
        // line 31
        if (1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 31, $this->source); })()), "ads", [], "any", false, false, false, 31)), 0)) {
            // line 32
            echo "            <div class=\"row\">
                ";
            // line 33
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 33, $this->source); })()), "ads", [], "any", false, false, false, 33));
            $context['loop'] = [
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["ad"]) {
                // line 34
                echo "                    ";
                $this->loadTemplate("ad/_ad.html.twig", "user/index.html.twig", 34)->display($context);
                // line 35
                echo "                ";
                ++$context['loop']['index0'];
                ++$context['loop']['index'];
...
";
    ...
    {
        return array (  198 => 44,  191 => 40,  187 => 38,  183 => 36,  169 => 35,  166 => 34,  149 => 33,  146 => 32,  144 => 31,  139 => 29,  132 => 25,  128 => 23,  121 => 19,  117 => 18,  114 => 17,  112 => 16,  108 => 15,  102 => 12,  95 => 10,  89 => 6,  79 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "user/index.html.twig", "/home/aubry/Bureau/projetbnb(copie)/projetbnbV9/templates/user/index.html.twig");
    }
}
