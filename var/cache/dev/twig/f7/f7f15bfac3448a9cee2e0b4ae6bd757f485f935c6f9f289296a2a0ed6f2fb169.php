...
class __TwigTemplate_5ccbb5ecbcf8d71f735e62ac5eec5c6067dd6230cf3bac26b0f3a8dfeaaebdb6 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container clearfix\">
        ...
        echo "\" > <input type=\"button\" class=\"btn btn-primary float-right\" onclick=\"window.location.href='this.parentNode.href.value\" value=\"Retour à mon profil\" /></a>
            ";
        // line 18
...
";
    ...
    {
        return array (  111 => 18,  107 => 17,  98 => 11,  94 => 10,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    <div class=\"container clearfix\">
        <div class=\"alert alert-light\">
            ...
            <a href=\"{{ path('account_index') }}\" > <input type=\"button\" class=\"btn btn-primary float-right\" onclick=\"window.location.href='this.parentNode.href.value\" value=\"Retour à mon profil\" /></a>
            {{ form_end(form) }}
        </div>
    <br>
    <br>
...
{% endblock %}", "account/password.html.twig", "/home/aubry/Bureau/projetbnb(copie)/projetbnbV9/templates/account/password.html.twig");
    }
}
