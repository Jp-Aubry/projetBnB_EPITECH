...
class __TwigTemplate_6aba635f66ff795facf427e0f6713662534dc326f965e91f77a4f762aee3051b extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\">
        ...
        <div class=\"col-md-6\">
            <div class=\"bg-light py-3 px-5\">
                ...
                ";
        // line 18
        if ((isset($context["hasError"]) || array_key_exists("hasError", $context) ? $context["hasError"] : (function () { throw new RuntimeError('Variable "hasError" does not exist.', 18, $this->source); })())) {
            // line 19
            echo "                    <div class=\"alert alert-danger\">Une erreur est survenue, 
                    le nom d'utilisateur ou le mot de passe est invalide</div>
                ";
        }
        // line 22
        echo "
...
";
    ...
    {
        return array (  118 => 26,  112 => 23,  109 => 22,  104 => 19,  102 => 18,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
    ...
    <div class=\"row\">
        ...
        <div class=\"col-md-6\">
            <div class=\"bg-light py-3 px-5\">
                ...
                {% if hasError %}
                    <div class=\"alert alert-danger\">Une erreur est survenue, 
                    le nom d'utilisateur ou le mot de passe est invalide</div>
                {% endif %}
...
{% endblock %}
", "account/login.html.twig", "/home/aubry/Bureau/projetbnb(copie)/projetbnbV9/templates/account/login.html.twig");
    }
}
